...
def test_history(tmpdir):
    ...
    assert jnp.all(new_history.tb_dict["test_tb"] == jnp.ones(12))
    chex.assert_tree_all_close(
        history.prms_dict["test_param"], new_history.prms_dict["test_param"]
    )
