...
def test_build_table_mixin():
    from shinrl.solvers.discrete_vi._build_table_mixin import BuildTableMixIn
...
def test_target_mixin():
    from shinrl.solvers.discrete_vi._build_table_mixin import BuildTableMixIn
    from shinrl.solvers.discrete_vi._target_mixin import QTargetMixIn
    from shinrl.solvers.discrete_vi.config import ViConfig
    ...
    mixins = MockSolver.make_mixins()
    solver = MockSolver.factory(env, config, mixins)
    q_targ = solver.target_tabular_dp(solver.data)
